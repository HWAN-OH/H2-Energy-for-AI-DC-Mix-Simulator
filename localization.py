# localization.py (v30.0 - Final Logic Flow)

loc_strings = {
    "en": {
        "app_title": "AI Datacenter Business Simulator",
        "app_subtitle": "A strategic tool to analyze the real-world P&L of AI services.",
        "model_clarification": "Note: The core analysis (Sections 1 & 2) is based on a **usage-based pricing system** to show the full potential of your strategy. Section 3 is a 'what-if' analysis based on your fixed-fee inputs.",
        ...
        "section_2_title": "2. Final Summary & Payback Analysis",
        ...
        "what_if_subtitle_scenario": "2. Fixed-Fee Analysis (Your Scenario)",
        ...
        "payback_analysis_intro": "Based on the core business potential (usage-based), the realistic payback period is calculated as follows:",
        ...
        "recommendation_intro": "To achieve a 5-year payback based on the architecture's full potential, the following monthly pricing is recommended:",
    ...
    "ko": {
        ...
        "model_clarification": "참고: 핵심 분석(섹션 1, 2)은 선택된 전략의 최대 잠재력을 보여주기 위해 **사용량 기반 요금제**를 기준으로 분석하며, 섹션 3은 입력하신 고정 요금제에 대한 'What-if' 분석입니다.",
        ...
        "section_2_title": "2. 최종 요약 및 투자 회수 기간 분석",
        ...
        "payback_analysis_intro": "핵심 사업 잠재력(사용량 기반)을 기준으로, 현실적인 투자 회수 기간은 다음과 같이 계산됩니다:",
