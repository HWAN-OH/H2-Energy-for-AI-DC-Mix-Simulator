# localization.py
# UI 텍스트를 위한 한/영 문자열 저장소 (v4.1)

loc_strings = {
    'ko': {
        'app_title': "💡 AI 서비스 사업성 시뮬레이터 (v4.1)",
        ...
        'assumed_fee_help': "현재 시장 상황을 고려하여, 일반 사용자에게 청구할 월 요금을 가정하여 입력합니다. 이 요금을 기준으로 '투자 회수 기간'이 계산됩니다.",
        ...
        'biz_model_assumptions_title': "수익 계산 근거 (가정)",
        'total_users_label': "총 사용자",
        'low_tier_users_label': "일반 사용자 (월 ${fee})",
        'high_tier_users_label': "고급 사용자 (월 ${fee})",
    ...
    'en': {
        'app_title': "💡 AI Service Business Case Simulator (v4.1)",
        ...
        'assumed_fee_help': "Enter an assumed monthly fee for regular users based on market conditions. The 'Payback Period' will be calculated based on this fee.",
        ...
        'biz_model_assumptions_title': "Basis for Revenue Calculation (Assumptions)",
        'total_users_label': "Total Users",
        'low_tier_users_label': "Regular Users (${fee}/mo)",
        'high_tier_users_label': "Premium Users (${fee}/mo)",
