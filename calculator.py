...
def calculate_business_case(dc_size_mw, use_clean_power, apply_mirrormind, high_perf_gpu_ratio, utilization_rate, market_price_per_m_tokens, lang):
    ...
    # --- 3. Apply Real-World Constraints (Utilization & Efficiency) ---
    ...
    # Revenue
    pnl['revenue'] = effective_tokens_serviced_m * 1000000 * (market_price_per_m_tokens / 1000000)

    # Cost of Revenue (Variable + Direct Fixed)
    # Simplified power estimation based on capacity and utilization
    power_cost_kwh = 0.18 if use_clean_power == "Renewable" else 0.12
    # Assuming 1 kWh produces 2000 tokens on average before efficiency
